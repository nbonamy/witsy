...
test('Renders correctly', async () => {
  ...
  expect(wrapper.find('.content .documents').exists()).toBe(true)
})
...
test('Renders documents', async () => {
  ...
  expect(wrapper.find('.content .documents .item:nth-child(1) .text').text()).toBe('file1')
  expect(wrapper.find('.content .documents .item:nth-child(1) .subtext').text()).toBe('/tmp/file1')
  ...
  expect(wrapper.find('.content .documents .item:nth-child(2) .text').text()).toBe('folder1 (2 common.files)')
  expect(wrapper.find('.content .documents .item:nth-child(2) .subtext').text()).toBe('/tmp/folder1')
