...
test('Save history', async () => {
  ...
  expect(window.api.history?.save).toHaveBeenLastCalledWith({
    ...
    chats: [ {
      ...
      messages: [
        { uuid: '1', engine: null, model: null, createdAt: 0, role: 'system', type: 'text', content: 'Hi', reasoning: null, expert: null, toolCall: null, attachment: null, usage: null, transient: false, uiOnly: false },
        { uuid: '2', engine: 'engine', model: 'model', createdAt: 0, role: 'user', type: 'text', content: 'Hello', reasoning: null, expert: null, toolCall: null, attachment: null, usage: null, transient: false, uiOnly: false }
      ]
    } ],
    quickPrompts: [],
  })
