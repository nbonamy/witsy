...
import Welcome from '@renderer/onboarding/Welcome.vue'
import Chat from '@renderer/onboarding/Chat.vue'
import Ollama from '@renderer/onboarding/Ollama.vue'
import Studio from '@renderer/onboarding/Studio.vue'
import Voice from '@renderer/onboarding/Voice.vue'
import Permissions from '@renderer/onboarding/Permissions.vue'
import Instructions from '@renderer/onboarding/Instructions.vue'
import Done from '@renderer/onboarding/Done.vue'
...
vi.mock('@services/llms/manager', async () => {
  return { 
    default: class {
      config: any
