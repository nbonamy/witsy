...
import { getSTTEngine, requiresDownload } from '@renderer/voice/stt'
import STTFalAi from '@renderer/voice/stt-falai'
import STTFireworks from '@renderer/voice/stt-fireworks'
import STTGladia from '@renderer/voice/stt-gladia'
import STTGroq from '@renderer/voice/stt-groq'
import STTHuggingFace from '@renderer/voice/stt-huggingface'
import STTMistral from '@renderer/voice/stt-mistral'
import STTNvidia from '@renderer/voice/stt-nvidia'
