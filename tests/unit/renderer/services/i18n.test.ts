...
import { getLocaleUI, getLocaleLLM, useI18n } from '@main/i18n'
import { commandI18n, commandI18nDefault, expertI18n, expertI18nDefault, i18nInstructions, localeToLangName } from '@services/i18n'
