...
import DeepResearchMultiStep from '@services/deepresearch_ms'
import DeepResearchMultiAgent from '@services/deepresearch_ma'
import DeepResearchAL, { mainLoopAgent, getComponentType } from '@services/deepresearch_al'
import * as dr from '@services/deepresearch'
import Chat from '@models/chat'
import Message from '@models/message'
import SearchPlugin from '@services/plugins/search'
...
// Mock dependencies
vi.mock('@services/plugins/search')
vi.mock('@services/generator')
vi.mock('@services/plugins/agent')

// Mock LlmUtils
vi.mock('@services/llm_utils', () => {
  return {
...
// Mock useTools
vi.mock('@renderer/composables/tools', () => ({
...
test('DeepResearchMultiStep complete agent chain execution', async () => {
  ...
  const LlmUtilsMock = vi.mocked(await import('@services/llm_utils')).default
