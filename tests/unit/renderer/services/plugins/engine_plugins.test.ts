...
import Image from '@services/plugins/image'
import Video from '@services/plugins/video'
import Browse from '@services/plugins/browse'
import Search from '@services/plugins/search'
import Python from '@services/plugins/python'
import YouTube from '@services/plugins/youtube'
import Memory from '@services/plugins/memory'
import Computer from '@services/plugins/computer'
import Mcp from '@services/plugins/mcp'
