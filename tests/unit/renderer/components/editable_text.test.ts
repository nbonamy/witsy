...
test('Can set selection', async () => {
  ...
  await wrapper.vm.$nextTick()
  expect(wrapper.find('.content').element.innerHTML).toBe('<div><span>H</span><span class="selected">el</span><span>lo</span></div><div><span>Bonjour</span></div>')
  wrapper.vm.setContent({ content: 'Hello\n\nBonjour\n', start: 1, end: 9 })
  await wrapper.vm.$nextTick()
  expect(wrapper.find('.content').element.innerHTML).toBe('<div><span>H</span><span class="selected">ello</span></div><div><span class="selected">&nbsp;</span></div><div><span class="selected">Bo</span><span>njour</span></div><div><span>&nbsp;</span></div>')
})
...
test('Can transform selection', async () => {
  ...
  await wrapper.vm.$nextTick()
  expect(wrapper.find('.content').element.innerHTML).toBe('<div><span>H</span><span class="selected">ello&nbsp;</span></div><div><span class="selected">&nbsp;&nbsp;</span></div><div><span class="selected">Bo</span><span>njour</span></div>')
