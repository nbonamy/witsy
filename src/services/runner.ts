...
export default class extends Generator {
  ...
  async run(trigger: AgentRunTrigger, prompt?: string, opts?: RunnerCompletionOpts): Promise<void> {
    ...
    try {
      ...
      // we need a chat
      const system: Message = new Message('system', this.agent.instructions)
      ...
      opts.model = this.agent.model || this.llmManager.getChatModel(opts.engine)
