      ...
      <div class="test-input">
        ...
        <div class="test-controls">
          <Waveform
            ...
            :audio-recorder="voiceRecordingInstance.audioRecorder"
            :is-recording="true"
          />
...
const voiceRecordingInstance = shallowRef(useVoiceRecording({
...
const onChangeModel = async () => {
  ...
  const saveConfig = () => {
    ...
    store.saveSettings()
    // Refresh voiceRecording with new config
    refreshVoiceRecording()
  }
...
.test-controls svg.initializing {
  color: orange;
}
