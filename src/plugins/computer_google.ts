    ...
    return [
      {
        ...
        function: {
          ...
          parameters: {
            type: 'object',
            properties: {
              url: { name: 'url', type: 'string', description: 'URL to open' }
            },
            required: ['url']
          }
        }
      },
      {
        ...
        function: {
          ...
          parameters: {
            type: 'object',
            properties: {
              url: { name: 'url', type: 'string', description: 'URL to navigate to' }
            },
            required: ['url']
          }
        }
      ...
      },
      {
        ...
        function: {
          ...
          parameters: {
            type: 'object',
            properties: {
              x: { name: 'x', type: 'number', description: 'X coordinate (0-999)' },
              y: { name: 'y', type: 'number', description: 'Y coordinate (0-999)' }
            },
            required: ['x', 'y']
          }
        }
        ...
        function: {
          ...
          parameters: {
            ...
            properties: {
              x: { name: 'x', type: 'number', description: 'X coordinate (0-999)' },
              y: { name: 'y', type: 'number', description: 'Y coordinate (0-999)' },
              text: { name: 'text', type: 'string', description: 'Text to type' }
            },
            required: ['x', 'y', 'text']
          }
        }
      },
      {
        ...
        function: {
          ...
          parameters: {
            type: 'object',
            properties: {
              direction: { name: 'direction', type: 'string', description: 'Direction: up, down, left, or right' },
              amount: { name: 'amount', type: 'number', description: 'Amount to scroll (default: 3)' }
            },
            required: ['direction']
          }
        }
        ...
        function: {
          ...
          parameters: {
            ...
            properties: {
              x: { name: 'x', type: 'number', description: 'X coordinate (0-999)' },
              y: { name: 'y', type: 'number', description: 'Y coordinate (0-999)' },
              direction: { name: 'direction', type: 'string', description: 'Scroll direction' },
              amount: { name: 'amount', type: 'number', description: 'Amount to scroll' }
            },
      ...
      },
      {
        ...
        function: {
          ...
          parameters: {
            type: 'object',
            properties: {
              keys: { name: 'keys', type: 'array', items: { type: 'string' }, description: 'Array of keys to press together' }
            },
            required: ['keys']
          }
        }
      },
      {
        ...
        function: {
          ...
          parameters: {
            type: 'object',
            properties: {
              from_x: { name: 'from_x', type: 'number', description: 'Source X coordinate (0-999)' },
              from_y: { name: 'from_y', type: 'number', description: 'Source Y coordinate (0-999)' },
              to_x: { name: 'to_x', type: 'number', description: 'Target X coordinate (0-999)' },
              to_y: { name: 'to_y', type: 'number', description: 'Target Y coordinate (0-999)' }
            },
